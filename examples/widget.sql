...
CREATE TABLE 'widget' ('widget_id' INTEGER PRIMARY KEY AUTOINCREMENT, 'debug', 'undefined_id');
INSERT INTO "widget" VALUES(1,'on',1);
CREATE TABLE 'window' ('window_id' INTEGER PRIMARY KEY AUTOINCREMENT, 'title', 'name', 'width', 'height', 'widget_id');
INSERT INTO "window" VALUES(1,'Sample Konfabulator Widget','main_window',500,500,1);
CREATE TABLE 'image' ('image_id' INTEGER PRIMARY KEY AUTOINCREMENT, 'src', 'name', 'hOffset', 'vOffset', 'alignment', 'widget_id');
INSERT INTO "image" VALUES(1,'Images/Sun.png','sun1',250,250,'center',1);
CREATE TABLE 'text' ('text_id' INTEGER PRIMARY KEY AUTOINCREMENT, 'data', 'size', 'style', 'name', 'hOffset', 'vOffset', 'alignment', 'onMouseUp', 'widget_id');
