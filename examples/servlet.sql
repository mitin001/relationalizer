...
CREATE TABLE 'servlet' (id INTEGER PRIMARY KEY AUTOINCREMENT, 'servlet-name', 'servlet-class', 'web-app_id');
...
CREATE TABLE 'servlet-mapping' (id INTEGER PRIMARY KEY AUTOINCREMENT, 'cofaxCDS', 'cofaxEmail', 'cofaxAdmin', 'fileServlet', 'cofaxTools', 'web-app_id');
INSERT INTO "servlet-mapping" VALUES(1,'/','/cofaxutil/aemail/*','/admin/*','/static/*','/tools/*',1);
CREATE TABLE 'taglib' (id INTEGER PRIMARY KEY AUTOINCREMENT, 'taglib-uri', 'taglib-location', 'web-app_id');
INSERT INTO "taglib" VALUES(1,'cofax.tld','/WEB-INF/tlds/cofax.tld',1);
CREATE TABLE 'init-param' (id INTEGER PRIMARY KEY AUTOINCREMENT, 'configGlossary:installationAt', 'configGlossary:adminEmail', 'configGlossary:poweredBy', 'configGlossary:poweredByIcon', 'configGlossary:staticPath', 'templateProcessorClass', 'templateLoaderClass', 'templatePath', 'templateOverridePath', 'defaultListTemplate', 'defaultFileTemplate', 'useJSP', 'jspListTemplate', 'jspFileTemplate', 'cachePackageTagsTrack', 'cachePackageTagsStore', 'cachePackageTagsRefresh', 'cacheTemplatesTrack', 'cacheTemplatesStore', 'cacheTemplatesRefresh', 'cachePagesTrack', 'cachePagesStore', 'cachePagesRefresh', 'cachePagesDirtyRead', 'searchEngineListTemplate', 'searchEngineFileTemplate', 'searchEngineRobotsDb', 'useDataStore', 'dataStoreClass', 'redirectionClass', 'dataStoreName', 'dataStoreDriver', 'dataStoreUrl', 'dataStoreUser', 'dataStorePassword', 'dataStoreTestQuery', 'dataStoreLogFile', 'dataStoreInitConns', 'dataStoreMaxConns', 'dataStoreConnUsageLimit', 'dataStoreLogLevel', 'maxUrlLength', 'servlet_id', 'mailHost', 'mailHostOverride', 'log', 'logLocation', 'logMaxSize', 'dataLog', 'dataLogLocation', 'dataLogMaxSize', 'removePageCache', 'removeTemplateCache', 'fileTransferFolder', 'lookInContext', 'adminGroupID', 'betaServer');
