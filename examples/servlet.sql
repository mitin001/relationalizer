...
CREATE TABLE 'web-app' ('web-app_id' INTEGER PRIMARY KEY AUTOINCREMENT, 'undefined_id');
INSERT INTO "web-app" VALUES(1,1);
CREATE TABLE 'servlet' ('servlet_id' INTEGER PRIMARY KEY AUTOINCREMENT, 'servlet-name', 'servlet-class', 'web-app_id');
...
CREATE TABLE 'servlet-mapping' ('servlet-mapping_id' INTEGER PRIMARY KEY AUTOINCREMENT, 'cofaxCDS', 'cofaxEmail', 'cofaxAdmin', 'fileServlet', 'cofaxTools', 'web-app_id');
INSERT INTO "servlet-mapping" VALUES(1,'/','/cofaxutil/aemail/*','/admin/*','/static/*','/tools/*',1);
CREATE TABLE 'taglib' ('taglib_id' INTEGER PRIMARY KEY AUTOINCREMENT, 'taglib-uri', 'taglib-location', 'web-app_id');
